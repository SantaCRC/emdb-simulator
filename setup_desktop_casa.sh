...
export VENV_SITE_PACKAGES="$HOME/Documents/data/TFM/.tfm/lib/python3.10/site-packages"
export PYTHONPATH="$VENV_SITE_PACKAGES:$PYTHONPATH"

# 6. Workspace ROS 2
if [ -f ~/Documents/data/TFM/ros_packages/install/setup.bash ]; then
...
alias colcon_dev="$HOME/Documents/data/TFM/.tfm/bin/python -m colcon build --symlink-install"

# 9. Alias útil para limpiar y recompilar
alias colcon_clean_build="cd ~/Documents/data/TFM/ros_packages && rm -rf build install log && $HOME/Documents/data/TFM/.tfm/bin/python -m colcon build --symlink-install"
