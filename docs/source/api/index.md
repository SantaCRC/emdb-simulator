...
Auto-generated from docstrings. `emdb_interfaces` has no Python source of its
own (see {doc}`../interfaces/index` instead); the pages below cover
`emdb_policy` and `emdb_simulator`.
